                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 col-lg-12 col-md-6">
                                                    <ul class="list-inner-wrap mb-mb-0 mb-3 mb-lg-3 mb-xl-0">
                                                        <li><img src="<?php echo esc_url( get_template_directory_uri(  ) ); ?>/assets/img/icon/check.png" alt="img"> Unlimited Revisions</li>
                                                        <li><img src="<?php echo esc_url( get_template_directory_uri(  ) ); ?>/assets/img/icon/check.png" alt="img">Best Fitness Excercise</li>
                                                        <li><img src="<?php echo esc_url( get_template_directory_uri(  ) ); ?>/assets/img/icon/check.png" alt="img">Combine Fitness and</li>
                                                        <li><img src="<?php echo esc_url( get_template_directory_uri(  ) ); ?>/assets/img/icon/check.png" alt="img">Best Solutions</li>
                                                    </ul>
                                                </div>
                                                <div class="col-xl-6 col-lg-12 col-md-6 align-self-center">
                                                    <div class="thumb"><img src="<?php echo esc_url( get_template_directory_uri(  ) ); ?>/assets/img/about/3.png" alt="img"></div>
                                                </div>
                                            </div>
                                            <div class="btn-wrap">
                                                <a class="btn btn-base" href="about.html">ABOUT MORE</a>
                                                <div class="author-wrap">
                                                    <div class="thumb"><img src="<?php echo esc_url( get_template_directory_uri(  ) ); ?>/assets/img/about/4.png" alt="img"></div>
                                                    <div class="details">
